        ...
        <ul class="activity-list">
            <li>
                <div class="activity-user">
                    <a href="profile.html" title="" data-toggle="tooltip"
                        ...
                        <img alt="Lesley Grauer" src="{{asset('admin/assets/img/customer/profile3.jpg')}}"
                            class=" img-fluid">
                    </a>
                </div>
            ...
            <li>
                <div class="activity-user">
                    <a href="profile.html" title="" data-toggle="tooltip"
                        data-original-title="Lesley Grauer">
                        <img alt="Lesley Grauer" src="{{asset('admin/assets/img/customer/profile4.jpg')}}"
                            class=" img-fluid">
                    </a>
                </div>
                <div class="activity-content">
            ...
            <li>
                <div class="activity-user">
                    <a href="profile.html" title="" data-toggle="tooltip"
                        data-original-title="Lesley Grauer">
                        <img alt="Lesley Grauer" src="{{asset('admin/assets/img/customer/profile5.jpg')}}"
                            class=" img-fluid">
                    </a>
                </div>
                <div class="activity-content">
            ...
            <li>
                <div class="activity-user">
                    <a href="profile.html" title="" data-toggle="tooltip"
                        data-original-title="Lesley Grauer">
                        <img alt="Lesley Grauer" src="{{asset('admin/assets/img/customer/customer4.jpg')}}"
                            class=" img-fluid">
                    </a>
                </div>
                <div class="activity-content">
