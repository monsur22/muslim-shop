                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-sm-2 col-2 ps-0">
                                <div class="add-icon">
                                    <a href="javascript:void(0);"><img src="{{asset('admin/assets/img/icons/plus1.svg')}}" alt="img"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="text-end">2000.00</td>
                            <td>
                                <a class="delete-set"><img src="{{asset('admin/assets/img/icons/delete.svg')}}" alt="svg"></a>
                            </td>
                        </tr>
                        <tr>
                            <td class="productimgname">
