...
@section('content')
    <div class="page-header">
        <div class="page-title">
            <h4>Expenses Category LIST </h4>
            <h6>Manage your purchases</h6>
        </div>
        <div class="page-btn">
            <a href="{{route('expense-category.create')}}" class="btn btn-added"><img src="{{asset('admin/assets/img/icons/plus.svg')}}" class="me-2" alt="img">Add New Expense</a>
        </div>
    </div>
