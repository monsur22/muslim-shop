    ...
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="createpurchasereturn.html" class="btn btn-added">
                <img src="{{asset('admin/assets/img/icons/plus.svg')}}" alt="img" class="me-2">Add Purchase Return
            </a>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table datanew">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="product-img">
                                <img src="{{asset('admin/assets/img/product/product8.jpg')}}" alt="product">
                            </a>
                        </td>
                        <td>3/24/2022</td>
                        <td>Best Power Tools</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="product-img">
                                <img src="{{asset('admin/assets/img/product/product9.jpg')}}" alt="product">
                            </a>
                        </td>
                        <td>3/24/2022</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="product-img">
                                <img src="{{asset('admin/assets/img/product/product10.jpg')}}" alt="product">
                            </a>
                        </td>
                        <td>3/24/2022</td>
                        <td>Best Power Tools</td>
