...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="addbrand.html" class="btn btn-added"><img src="{{asset('admin/assets/img/icons/plus.svg')}}" class="me-2" alt="img">Add Brand</a>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table datanew">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="product-img">
                                <img src="{{asset('admin/assets/img/brand/colgate.png')}}" alt="product">
                            </a>
                        </td>
                        <td>Colgate</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="product-img">
                                <img src="{{asset('admin/assets/img/brand/samsung.png')}}" alt="product">
                            </a>
                        </td>
                        <td>samsung</td>
                        <td>Electronics</td>
