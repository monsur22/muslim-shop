                ...
                <div class="card mb-sm-3 mb-md-0 contacts_card flex-fill">
                    ...
                    <div class="card-body contacts_body chat-users-list chat-scroll">
                        <a href="javascript:void(0);" class="media d-flex active">
                            <div class="media-img-wrap flex-shrink-0">
                                <div class="avatar avatar-away">
                                    <img src="{{('admin/assets/img/customer/customer1.jpg')}}" alt="User Image"
                        ...
                        <a href="javascript:void(0);" class="media d-flex read-chat">
                            <div class="media-img-wrap flex-shrink-0">
                                <div class="avatar avatar-online">
                                    <img src="{{('admin/assets/img/customer/customer2.jpg')}}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body flex-grow-1">
                        ...
                        <a href="javascript:void(0);" class="media d-flex">
                            <div class="media-img-wrap flex-shrink-0">
                                <div class="avatar avatar-away">
                                    <img src="{{('admin/assets/img/customer/customer3.jpg')}}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body flex-grow-1">
                        ...
                        <a href="javascript:void(0);" class="media read-chat d-flex">
                            <div class="media-img-wrap flex-shrink-0">
                                <div class="avatar avatar-online">
                                    <img src="{{('admin/assets/img/customer/customer4.jpg')}}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body flex-grow-1">
                        ...
                        <a href="javascript:void(0);" class="media read-chat d-flex">
                            <div class="media-img-wrap flex-shrink-0">
                                <div class="avatar avatar-offline">
                                    <img src="{{('admin/assets/img/customer/customer5.jpg')}}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body flex-grow-1">
                        ...
                        <a href="javascript:void(0);" class="media read-chat d-flex">
                            <div class="media-img-wrap flex-shrink-0">
                                <div class="avatar avatar-online">
                                    <img src="{{('admin/assets/img/customer/customer6.jpg')}}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body flex-grow-1">
                        ...
                        <a href="javascript:void(0);" class="media read-chat d-flex">
                            <div class="media-img-wrap flex-shrink-0">
                                <div class="avatar avatar-away">
                                    <img src="{{('admin/assets/img/customer/customer7.jpg')}}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body flex-grow-1">
                                <div>
                                    ...
                                    <div class="user-last-chat">This has allowed me to showcase not only my technical skills
                                    </div>
                                </div>
                                <div>
                        ...
                        <a href="javascript:void(0);" class="media read-chat d-flex">
                            <div class="media-img-wrap flex-shrink-0">
                                <div class="avatar avatar-offline">
                                    <img src="{{('admin/assets/img/customer/customer8.jpg')}}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body flex-grow-1">
                ...
                <div class="card mb-0">
                    <div class="card-header msg_head">
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="img_cont">
                                <img class="rounded-circle user_img" src="{{('admin/assets/img/customer/profile2.jpg')}}"
                                    alt="">
                            </div>
                            <div class="user_info">
                    ...
                    <div class="card-body msg_card_body chat-scroll">
                        <ul class="list-unstyled">
                            ...
                            <li class="media received d-flex">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{('admin/assets/img/customer/profile2.jpg')}}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="media-body flex-grow-1">
                                    <div class="msg-box">
                                        ...
                                        <div>
                                            <div class="chat-msg-attachments">
                                                <div class="chat-attachment">
                                                    <img src="{{('admin/assets/img/product/product12.jpg')}}" alt="Attachment">
                                                    <a href="" class="chat-attach-download">
                                                        <i class="fas fa-download"></i>
                                                    </a>
                                                </div>
                                                <div class="chat-attachment">
                                                    <img src="{{('admin/assets/img/product/product13.jpg')}}" alt="Attachment">
                                                    <a href="" class="chat-attach-download">
                                                        <i class="fas fa-download"></i>
                                                    </a>
                                                </div>
                                ...
                                <div class="media-body flex-grow-1">
                                    ...
                                    <div class="msg-box">
                                        <div>
                                            <div class="chat-msg-attachments">
                                                <div class="chat-attachment">
                                                    <img src="{{('admin/assets/img/product/product15.jpg')}}" alt="Attachment">
                                                    <a href="" class="chat-attach-download">
                                                        <i class="fas fa-download"></i>
                                                    </a>
                                                </div>
